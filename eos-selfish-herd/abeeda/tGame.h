...
public:
    ...
    void loadExperiment(char *filename);
    string executeGame(vector<tAgent*> swarmAgents, tAgent* predatorAgent, FILE *data_file, bool report, double startingDist, double predatorVisionRange, double predatorVisionAngle, int killDelay, int numPredators, double &swarmdensity, double &hdaa_no);
    tGame();
    ~tGame();
